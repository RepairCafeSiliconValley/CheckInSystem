export default function Input({ label, value, onChange, onBlur, placeholder, type = "text", required = false, inputMode, maxLength, min, step }) {
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <input type={type} value={value} onChange={(e) => onChange(e.target.value)} placeholder={placeholder} inputMode={inputMode} maxLength={maxLength} min={min} step={step}
