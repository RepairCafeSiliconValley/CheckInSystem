export default function StatusBadge({ status }) {
  const map = {
    pending: { label: "Pending Print", color: "#b54708", bg: "#fef6ee" },
    pending_assignment: { label: "Waiting for Fixer", color: "#1e3a6e", bg: "#eef2f8" },
    assigned: { label: "With Fixer", color: "#6941c6", bg: "#f4f3ff" },
    completed: { label: "Completed", color: "#2e7d32", bg: "#e8f5e9" },
    canceled: { label: "Canceled", color: "#667085", bg: "#f2f4f7" },
  };
